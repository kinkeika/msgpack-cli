...
namespace MsgPack
{
	...
	public partial class TimestampTest
	{
		...
		public void TestConstractor_Max_Ok()
		{
			...
			Assert.That( target.NanosecondsPart, Is.EqualTo( Timestamp.MaxValue.Nanosecond ) );
		}
		...
		public void TestConstractor_Min_Ok()
		{
			...
			Assert.That( target.NanosecondsPart, Is.EqualTo( Timestamp.MinValue.Nanosecond ) );
		}
